...
import '../Domain/Repositories/data_sources/remote_data_source/auth_remote_data_source.dart'
    as _i556;
import '../Domain/use_cases/login_use_case.dart' as _i104;
import '../Domain/use_cases/register_use_case.dart' as _i209;
import '../features/ui/auth/login/login_view_model.dart' as _i285;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i556.AuthRemoteDataSource>(() =>
        _i279.AuthRemoteDataSourceImpl(apiManager: gh<_i123.ApiManager>()));
    ...
    gh.factory<_i104.LoginUseCase>(() => _i104.LoginUseCase(
        authRepositoryContract: gh<_i1031.AuthRepositoryContract>()));
    gh.factory<_i285.LoginViewModel>(
        () => _i285.LoginViewModel(loginUseCase: gh<_i104.LoginUseCase>()));
